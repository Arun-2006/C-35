...
if(box1.isTouching(monster) || box2.isTouching(monster) || box3.isTouching(monster) || box4.isTouching(monster) ||box5.isTouching(monster) ||box6.isTouching(monster) ||box7.isTouching(monster) ||box8.isTouching(monster) ||box9.isTouching(monster) ||box10.isTouching(monster) ||box11.isTouching(monster) ||box12.isTouching(monster) ||box13.isTouching(monster) ||box14.isTouching(monster) ||box15.isTouching(monster) ||box16.isTouching(monster) ||box17.isTouching(monster) ||box18.isTouching(monster) ||box19.isTouching(monster) ||box20.isTouching(monster) ||box21.isTouching(monster) ||box22.isTouching(monster) ||box23.isTouching(monster) ||box24.isTouching(monster) ||box25.isTouching(monster) ||box26.isTouching(monster))
{
